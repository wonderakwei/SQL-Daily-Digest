...
### 🎯 Day 2: Removing Duplicate Rows

#### 1️⃣ Setup: Re-Create Table with Duplicates
...
**Result** (Conceptual: These are the rows marked for deletion)
...
**Result** (Conceptual: Before/After)
