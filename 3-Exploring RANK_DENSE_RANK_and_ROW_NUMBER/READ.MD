...
### 🎯 Day 3: Exploring RANK, DENSE_RANK, and ROW_NUMBER
...
```sql
--create the table for Day 3 practice
...
**Result** (Focus on the ranks for the tie-breakers)

![initial query](results_ranks.png)
